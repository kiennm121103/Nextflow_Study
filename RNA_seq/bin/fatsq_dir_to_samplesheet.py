...
def parse_args(args=None):
    Description = "Generate RNA seq samplesheet from a directory of FastQ files."
...
def fastq_dir_to_samplesheet(
    ...
    def sanitize_sample(path, extension):
        """Retrieve sample id from filenam"""
